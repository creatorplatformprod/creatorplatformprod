    ...
    <div className={`min-h-screen feed-bg public-template public-template-${templateStyleClass} template-layout template-layout-${templateStyleClass} ${showSidebar && sidebarOpen ? 'template-sidebar-open' : 'template-sidebar-closed'}`}>
      ...
      <div className="profile-hero template-hero relative">
        ...
        <div className={`template-profile-shell relative max-w-[1400px] mx-auto px-4 -mt-16 sm:-mt-20 pb-6 sm:pb-8 transition-all duration-300 ${mainOffsetClass}`}>
          <div className="template-profile-row flex flex-col sm:flex-row items-center sm:items-start gap-5">
            ...
            {allCollections.length > 0 && (
              <button
                ...
                className="template-unlock-cta relative overflow-hidden mt-3 sm:mt-5 ml-0 md:ml-auto md:mr-8 lg:mr-10 self-center md:self-center text-lg sm:text-xl md:text-2xl font-extrabold tracking-tight text-transparent transition-all"
              >
                <span
          ...
          <div className={`template-filter-shell template-filter-container mt-5 pt-3 lg:pt-4 lg:border-t lg:border-border/70 mx-auto sm:mx-0 flex items-center gap-1 p-1 bg-gray-50 rounded-xl border border-gray-200 w-fit`}>
