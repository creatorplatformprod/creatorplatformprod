          ...
          <div className="flex-1 min-w-0 w-full">
            <div className="relative mx-auto max-w-[920px]">
              ...
              <div className="mt-5 flex justify-center">
                <div className="w-[82%] sm:w-[88%] lg:w-[92%] h-[22px] bg-gradient-to-b from-[#1b2331] to-[#0f131b] rounded-[999px] shadow-[0_20px_45px_rgba(2,6,23,0.55)]" />
              </div>
              <div className="mt-1 flex justify-center">
                <div className="w-[64%] sm:w-[72%] lg:w-[78%] h-[12px] bg-gradient-to-b from-[#2f3746] to-[#171c27] rounded-[999px] [transform:perspective(1200px)_rotateX(10deg)] shadow-[0_12px_28px_rgba(2,6,23,0.5)]" />
              </div>
            </div>
          </div>

          <div className="w-full lg:w-[380px] flex justify-center">
            <div className="bg-[#0b0f16] rounded-[40px] p-3 sm:p-4 shadow-[0_25px_70px_rgba(2,6,23,0.55)] border border-white/10 w-[300px] sm:w-[320px] lg:w-[340px]">
