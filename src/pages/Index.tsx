...
>
                ...
                <div className="px-3 py-2 border-t border-border flex-shrink-0">
                  ...
                  <div className="flex items-center justify-center gap-2">
                    <a
                      href="https://twitter.com/tatianavolkova"
                      target="_blank"
                    ...
                    <div className="grid grid-cols-2 gap-8 md:contents">
                      ...
                      <div>
                        ...
                        <div className="flex gap-3 mb-4">
                          <a href="https://twitter.com/tatianavolkova" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-secondary flex items-center justify-center">
                        ...
                        <p className="text-sm text-muted-foreground">info@tatianavolkova.com</p>
                      </div>
                    </div>
                  </div>
