                  ...
                  <div className="text-center">
                    ...
                    <div className="mb-3 sm:mb-4">
                      <input
                        ...
                        className="w-full px-3 sm:px-4 py-2 sm:py-3 text-xs sm:text-base bg-secondary/50 border border-border rounded-xl text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent shadow-[0_2px_8px_rgba(0,0,0,0.08)] dark:shadow-none"
                        required
                        maxLength={254}
                      />
                    </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div className="grid grid-cols-2 gap-8 md:contents">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">hello@lannadelulu.com</p>
                  </div>
                </div>
              </div>
