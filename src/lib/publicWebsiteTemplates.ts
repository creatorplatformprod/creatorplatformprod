export const PUBLIC_WEBSITE_TEMPLATES = [
  {
    ...
    source: "Webflow SaaS/portfolio dark templates and Framer creator portfolio patterns"
  },
  {
    id: "nord-minimal",
    name: "Nord Minimal",
    ...
    source: "Nord palette system + minimal portfolio template direction"
  },
  {
    id: "tokyo-neon",
    name: "Tokyo Neon",
    ...
    source: "Tokyo Night palette + high-contrast modern portfolio trends"
  },
  {
    id: "noir-luxe",
    name: "Noir Luxe",
    ...
    source: "Luxury dark editorial template direction (Webflow premium portfolio examples)"
  },
  {
    id: "electric-creator",
    ...
    source: "Creator platform template catalogs (Linktree/Beacons/Ko-fi style direction)"
  }
] as const;
