        ...
        <div className="grid md:grid-cols-3 gap-5 max-w-4xl mx-auto">
          ...
          <div className="card-elevated p-6 relative ring-2 ring-primary/20 flex flex-col" style={{ boxShadow: '0 8px 40px -8px rgba(14,165,233,0.12)' }}>
            <div className="absolute -top-3 left-4">
              <span className="inline-flex items-center gap-1 text-white text-xs font-medium px-3 py-1 rounded-full bg-indigo-500 shadow-sm">
            ...
            <Button 
              ...
              className="w-full mb-6 h-11 rounded-xl font-semibold shadow-sm bg-indigo-500 hover:bg-indigo-600 text-white border-0"
            >
              Get Pro
            </Button>
