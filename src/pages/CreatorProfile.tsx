  ...
  return (
    <div className={`min-h-screen feed-bg scrollbar-gutter-balanced public-template${templateStyleClass ? ` public-template-${templateStyleClass} template-layout template-layout-${templateStyleClass}` : ''} ${classicDarkClass} ${showSidebar && sidebarOpen ? 'template-sidebar-open' : 'template-sidebar-closed'}`}>
      ...
      <div className="profile-hero template-hero relative">
        ...
        <div className="template-cover relative h-72 sm:h-96 lg:h-[26rem] overflow-hidden -mb-[2px]">
          {heroCoverImage ? (
            <img
              src={heroCoverImage}
              alt="Profile cover"
        ...
        <div className={`template-profile-shell relative max-w-[1600px] mx-auto px-4 -mt-10 sm:-mt-14 pb-6 sm:pb-8 transition-all duration-300 ${mainOffsetClass}`}>
          {allCollections.length > 0 && (
            <div className="hidden lg:flex justify-end mb-3">
              ...
              >
                <span className="relative unlock-cta-brand-gradient unlock-cta-font unlock-cta-desktop-outline">Unlock Everything</span>
              </button>
            </div>
          )}
