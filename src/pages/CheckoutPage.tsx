...
const CheckoutPage = () => {
  ...
  const isValidCollectionId = (id) => {
    ...
    if (/^mock-collection-\d+$/i.test(id)) return true;
          ...
          {redirecting && !paymentError ? (
            <>
              <div className="relative mb-2">
                <div className="w-10 h-10 bg-primary rounded-full flex items-center justify-center mx-auto shadow-md animate-scale-in">
            ...
            <div className="lg:sticky lg:top-24">
              ...
              <div className={`space-y-5 ${showOrderDetails ? 'block' : 'hidden lg:block'}`}>
                ...
                <div className="flex items-start gap-4 p-4 rounded-2xl bg-secondary/35 border border-border">
                  <div className="w-16 h-16 rounded-xl bg-indigo-500/15 border border-border flex items-center justify-center flex-shrink-0">
