      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="flex flex-col lg:flex-row gap-10 items-start">
            ...
            <div className="relative mx-auto max-w-[1080px]">
              <div className="bg-[#0c1119] rounded-[20px] p-3 border border-white/10 shadow-[0_30px_80px_rgba(2,6,23,0.6)]">
                <div className="bg-black rounded-[14px] overflow-hidden border border-white/5">
                  <div className="relative mx-auto [--viewport-w:1440px] [--viewport-h:900px] [--scale:0.42] lg:[--scale:0.6] w-[calc(var(--viewport-w)*var(--scale))] h-[calc(var(--viewport-h)*var(--scale))]">
                    <iframe
          ...
          <div className="w-full lg:w-[460px] flex justify-center">
            <div className="bg-[#0b0f16] rounded-[40px] p-4 shadow-[0_25px_70px_rgba(2,6,23,0.55)] border border-white/10 w-[420px]">
